...
namespace OpenRA.Mods.Example.Games.Earth2140.Traits
{
	class PaletteFromMixInfo : TraitInfo, IProvidesCursorPaletteInfo
	{
		[PaletteDefinition]
		[FieldLoader.Require]
	...
	class PaletteFromMix : ILoadsPalettes, IProvidesAssetBrowserPalettes
	{
		...
		public PaletteFromMix(World world, PaletteFromMixInfo info)
		{
			this.world = world;
			this.info = info;
		}
